...
export function MainLayout() {
  return (
    <div className="grid min-h-screen grid-areas-layout grid-cols-1 md:grid-cols-[180px_1fr] grid-rows-[auto_1fr_auto] ">
      <header className="[grid-area:header]   bg-gradient-to-r from-zinc-900/93 via-stone-900/82 to-zinc-900/93  flex items-center justify-between  shadow-md p-4 z-10 sticky top-0  "></header>
