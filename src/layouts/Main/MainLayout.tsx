  ...
  return (
    ...
    >
      ...
      >
        ...
        <aside
          className={`[grid-area:sidebar] hidden md:block  shadow-md border-e contain-layout overflow-y-auto overflow-x-hidden [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] border-gray-500/40 `}
